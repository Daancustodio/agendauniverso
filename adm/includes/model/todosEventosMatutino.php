...
$i = mysqli_query($con, "SELECT * FROM eventos WHERE data>='$data' AND periodo = 'Matutino'  ORDER BY data");
$j = mysqli_num_rows($i);
if ($j == false){
    ...
    }else{while ($ln = mysqli_fetch_array($i)){
?>
            ...
            if($usuarioLogado == $ln['usuario']){
                echo'<div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="?p=editarEvento&id='.$ln["id"].' "title="Atenção, o Menu EDITAR ainda não está pronto, para alterar, basta EXLUIR esse item e Cadastre OUTRO com as Alterações necessárias">Editar</a></li>
                            <li class="divider"></li>
                            <li> <a href="?p=excluirEventoM&id='.$ln["id"].' " title="Clique aqui para Excluir">Excluir</a> </li>
