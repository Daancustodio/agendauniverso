<?php	
		// inicio de verificação caso usuário tenha editado seus dados
...
<form  method="POST"  action="index.php?p=salvaralteracaousuario" >
...
<br>   
    ...
    <label for="telefonetxt">Celular:</label>
     ...
     <center> <input type="submit" id="botao" name="enviar" value="Salvar" class="botao txt bradius">
	 </center></form>
</div></center>
</div>
<?php
		}//fim do laço 
		}// fim else de verificação de edição de dados
?>