...
$i = mysqli_query($con, "SELECT * FROM eventos WHERE data>='$data' AND periodo = 'Noturno'  ORDER BY data");
$j = mysqli_num_rows($i);
if ($j == false){
            ...
            if($usuarioLogado == $ln['usuario']){
                echo'<div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="divider"></li>
                            <li> <a href="?p=excluirEventoN&id='.$ln["id"].' " title="Clique aqui para Excluir">Excluir</a> </li>
