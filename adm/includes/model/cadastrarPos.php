<?php
	...
	$sql = mysqli_query($con, "SELECT * FROM posgraduacao WHERE data = '$data' AND local ='$local' AND periodo = '$periodo'");
	...
	if ($rows == true){
		...
		mysqli_query($con, "INSERT INTO posgraduacao (data, periodo, inicio, termino, local, professor, equipamentos, disciplina, usuario, dia) 
			values ('$data','$periodo', '$inicio', '$termino', '$local', '$professor', '$equipamentos', '$disciplina', '$usuarioLogado', '$dia' )");
